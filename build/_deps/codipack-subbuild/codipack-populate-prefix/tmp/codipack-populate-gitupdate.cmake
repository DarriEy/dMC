...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v2.2.0"
  WORKING_DIRECTORY "/Users/darrieythorsson/compHydro/code/dmc_design/build/_deps/codipack-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/darrieythorsson/compHydro/code/dmc_design/build/_deps/codipack-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/darrieythorsson/compHydro/code/dmc_design/build/_deps/codipack-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
